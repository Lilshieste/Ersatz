...
//		MockedFunction()
//		{
//			WillReturnDefault([](P1 parameter1, P2 parameter2){ return R(); });
//		}
//
//		~MockedFunction()
//		{
...
//		}
//
//		MockedFunction<R(P1, P2)>& WillReturnDefault(FunctionType defaultReturnExpression)
//		{
//			m_defaultReturnExpression = defaultReturnExpression;
//
//			return *this;
...
//		}
//
//		R Invoke(P1 parameter1, P2 parameter2) const
//		{
...
//				{
//					return matchResult.ReturnExpression(parameter1, parameter2);
//				}
//			}
//			
//			return m_defaultReturnExpression(parameter1, parameter2);
//		}
//
//	private:
//		std::string m_functionName;
