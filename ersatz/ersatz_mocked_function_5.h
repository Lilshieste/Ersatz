...
//	class MockedFunction<R(P1, P2, P3, P4, P5)>
//	{
//	public:
...
//		MockedFunction()
//		{
//			WillReturnDefault([](P1 parameter1, P2 parameter2, P3 parameter3, P4 parameter4, P5 parameter5){ return R(); });
//		}
//
//		~MockedFunction()
//		{
...
//		}
//
//		MockedFunction<R(P1, P2, P3, P4, P5)>& WillReturnDefault(FunctionType defaultReturnExpression)
//		{
//			m_defaultReturnExpression = defaultReturnExpression;
//
//			return *this;
...
//		}
//
//		R Invoke(P1 parameter1, P2 parameter2, P3 parameter3, P4 parameter4, P5 parameter5) const
//		{
...
//				{
//					return matchResult.ReturnExpression(parameter1, parameter2, parameter3, parameter4, parameter5);
//				}
//			}
//			
//			return m_defaultReturnExpression(parameter1, parameter2, parameter3, parameter4, parameter5);
//		}
//
//	private:
//		std::string m_functionName;
